...
# Parameters
#test_count = 1000
hist_settings = [(1,1,4), (1,1,8), (1,1,16),(2,2,4), (2,2,8),(2,2,16) ,(3,3,4), (3,3,8), (3,3,16), (4,4,4), (4,4,8),(4,4,16)]
dataset_name_base = "io_centrist_"
directory = "./data"
...
for hs in hist_settings:
    ...
    print("VAL")
    val_data_x, val_data_y, val_data_y_io = common.process_centrist_io(val_names, classes_val, classes_io, classes_nums, fname_begin_val, True, hs)
    common.save_to_h5(os.path.join(output_directory, 'val.h5'), val_data_x, val_data_y, val_data_y_io)
    print("TRAIN")
    train_data_x, train_data_y, train_data_y_io = common.process_centrist_io(train_names, classes, classes_io, classes_nums, fname_begin_train, False, hs)
    common.save_to_h5(os.path.join(output_directory, 'train.h5'), train_data_x, train_data_y, train_data_y_io)
    print("TEST")
    test_data_x, test_data_y, test_data_y_io = common.process_centrist_io(test_names, classes, classes_io, classes_nums, fname_begin_train, False, hs)
