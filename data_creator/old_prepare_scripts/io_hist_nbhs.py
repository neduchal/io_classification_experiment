...
# Parameters
#test_count = 1000
hist_settings = [(1,1), (2,2), (3,3), (4,4)]
dataset_name_base = "io_nbhs_"
directory = "./data"
...
for hs in hist_settings:
    ...
    print("VAL")
    val_data_x, val_data_y, val_data_y_io = common.process_nbhs_io(val_names, classes_val, classes_io, classes_nums, fname_begin_val, True, hs)
    common.save_to_h5(os.path.join(output_directory, 'val.h5'), val_data_x, val_data_y, val_data_y_io)
    print("TRAIN")
    train_data_x, train_data_y, train_data_y_io = common.process_nbhs_io(train_names, classes, classes_io, classes_nums, fname_begin_train, False, hs)
    common.save_to_h5(os.path.join(output_directory, 'train.h5'), train_data_x, train_data_y, train_data_y_io)
    print("TEST")
    test_data_x, test_data_y, test_data_y_io = common.process_nbhs_io(test_names, classes, classes_io, classes_nums, fname_begin_train, False, hs)
