...
# Parameters
#hist_settings = [(128,8),(128,16), (128,32), (128,64)]
#hist_settings = [(64,8),(64,16), (64,32), (64,64)]
hist_settings = [(32,8),(32,16), (32,32), (32,64)]
#hist_settings = [(16,8),(16,16), (16,32), (16,64)]
dataset_name_base = "hog_"
directory = "./data"
...
for hs in hist_settings:
    dataset_name = dataset_name_base + "_" + str(hs[0]) + "_" + str(hs[1])
    print("Creating dataset " + dataset_name)
    output_directory = os.path.join(output_path, dataset_name)
    if not os.path.exists(output_directory):
        os.makedirs(output_directory)
    print("VAL")
    val_data_x, val_data_y, val_data_y_io = common.process_hog(val_names, classes_val, classes_io, classes_nums, fname_begin_val, True, hs)
    common.save_to_h5(os.path.join(output_directory, 'val.h5'), val_data_x, val_data_y, val_data_y_io)
    print("TRAIN")
    train_data_x, train_data_y, train_data_y_io = common.process_hog(train_names, classes, classes_io, classes_nums, fname_begin_train, False, hs)
    common.save_to_h5(os.path.join(output_directory, 'train.h5'), train_data_x, train_data_y, train_data_y_io)
    print("TEST")
    test_data_x, test_data_y, test_data_y_io = common.process_hog(test_names, classes, classes_io, classes_nums, fname_begin_train, False, hs)
