...
val_data_x, val_data_y, val_data_y_io = common.process_hist_io(val_names, classes_val, classes_io, classes_nums, fname_begin_val, True, "hsv")
...
train_data_x, train_data_y, train_data_y_io = common.process_hist_io(train_names, classes, classes_io, classes_nums, fname_begin_train, False, "hsv")
common.save_to_h5(os.path.join(output_directory, 'train.h5'), train_data_x, train_data_y, train_data_y_io)

print("TEST")

test_data_x, test_data_y, test_data_y_io = common.process_hist_io(test_names, classes, classes_io, classes_nums, fname_begin_train, False, "hsv")
